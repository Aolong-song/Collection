...
public class ResponseUtil {
    ...
    public static Object collectionUnknown() {
        return fail(763, "收藏记录不存在");
    }

    public static Object collectionDeleteFail(){return fail(762, "收藏删除失败");}

    public static Object collectionInsertFail(){return fail(761,"收藏新增失败");}

    public static Object paramNotAllowed(){return fail(580,"参数不合法");}
}
